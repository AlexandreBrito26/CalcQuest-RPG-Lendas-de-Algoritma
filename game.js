...
rpg.battlePassRewards = [
  // ── TIER 1: Iniciante (1–10) ──
  { id: "bp_1",  tier: 1,  req: 1,    icon: "coins",          color: "text-yellow-400",  name: { pt: "300 Ouro",          en: "300 Gold"           }, type: "gold",  value: 300 },
  { id: "bp_2",  tier: 1,  req: 3,    icon: "flask-round",    color: "text-emerald-400", name: { pt: "5 Poções",          en: "5 Potions"          }, type: "pot",   value: 5 },
  { id: "bp_3",  tier: 1,  req: 5,    icon: "coins",          color: "text-yellow-400",  name: { pt: "1K Ouro",           en: "1K Gold"            }, type: "gold",  value: 1000 },
  { id: "bp_4",  tier: 1,  req: 8,    icon: "flask-round",    color: "text-emerald-400", name: { pt: "10 Poções",         en: "10 Potions"         }, type: "pot",   value: 10 },
  { id: "bp_5",  tier: 1,  req: 10,   icon: "coins",          color: "text-yellow-400",  name: { pt: "3K Ouro",           en: "3K Gold"            }, type: "gold",  value: 3000 },
  { id: "bp_6",  tier: 1,  req: 15,   icon: "coins",          color: "text-yellow-400",  name: { pt: "8K Ouro",           en: "8K Gold"            }, type: "gold",  value: 8000 },
  { id: "bp_7",  tier: 1,  req: 20,   icon: "flask-round",    color: "text-emerald-400", name: { pt: "25 Poções",         en: "25 Potions"         }, type: "pot",   value: 25 },
  { id: "bp_8",  tier: 1,  req: 25,   icon: "coins",          color: "text-yellow-400",  name: { pt: "20K Ouro",          en: "20K Gold"           }, type: "gold",  value: 20000 },
  { id: "bp_9",  tier: 1,  req: 30,   icon: "flask-round",    color: "text-emerald-400", name: { pt: "50 Poções",         en: "50 Potions"         }, type: "pot",   value: 50 },
  { id: "bp_10", tier: 1,  req: 40,   icon: "coins",          color: "text-amber-400",   name: { pt: "60K Ouro",          en: "60K Gold"           }, type: "gold",  value: 60000 },

  // ── TIER 2: Caçador (11–20) ──
  { id: "bp_11", tier: 2,  req: 50,   icon: "coins",          color: "text-amber-400",   name: { pt: "150K Ouro",         en: "150K Gold"          }, type: "gold",  value: 150000 },
  { id: "bp_12", tier: 2,  req: 60,   icon: "flask-round",    color: "text-emerald-400", name: { pt: "80 Poções",         en: "80 Potions"         }, type: "pot",   value: 80 },
  { id: "bp_13", tier: 2,  req: 75,   icon: "coins",          color: "text-amber-400",   name: { pt: "400K Ouro",         en: "400K Gold"          }, type: "gold",  value: 400000 },
  { id: "bp_14", tier: 2,  req: 90,   icon: "flask-round",    color: "text-emerald-400", name: { pt: "120 Poções",        en: "120 Potions"        }, type: "pot",   value: 120 },
  { id: "bp_15", tier: 2,  req: 100,  icon: "zap",            color: "text-orange-400",  name: { pt: "1M Ouro",           en: "1M Gold"            }, type: "gold",  value: 1000000 },
  { id: "bp_16", tier: 2,  req: 120,  icon: "flask-round",    color: "text-emerald-400", name: { pt: "200 Poções",        en: "200 Potions"        }, type: "pot",   value: 200 },
  { id: "bp_17", tier: 2,  req: 150,  icon: "coins",          color: "text-orange-400",  name: { pt: "5M Ouro",           en: "5M Gold"            }, type: "gold",  value: 5000000 },
  { id: "bp_18", tier: 2,  req: 175,  icon: "flask-round",    color: "text-emerald-400", name: { pt: "300 Poções",        en: "300 Potions"        }, type: "pot",   value: 300 },
  { id: "bp_19", tier: 2,  req: 200,  icon: "star",           color: "text-orange-300",  name: { pt: "15M Ouro",          en: "15M Gold"           }, type: "gold",  value: 15000000 },
  { id: "bp_20", tier: 2,  req: 250,  icon: "flask-round",    color: "text-emerald-400", name: { pt: "500 Poções",        en: "500 Potions"        }, type: "pot",   value: 500 },

  // ── TIER 3: Veterano (21–30) ──
  { id: "bp_21", tier: 3,  req: 300,  icon: "coins",          color: "text-red-400",     name: { pt: "50M Ouro",          en: "50M Gold"           }, type: "gold",  value: 50000000 },
  { id: "bp_22", tier: 3,  req: 350,  icon: "flask-round",    color: "text-emerald-400", name: { pt: "750 Poções",        en: "750 Potions"        }, type: "pot",   value: 750 },
  { id: "bp_23", tier: 3,  req: 400,  icon: "crown",          color: "text-red-400",     name: { pt: "200M Ouro",         en: "200M Gold"          }, type: "gold",  value: 200000000 },
  { id: "bp_24", tier: 3,  req: 450,  icon: "flask-round",    color: "text-emerald-400", name: { pt: "1000 Poções",       en: "1000 Potions"       }, type: "pot",   value: 1000 },
  { id: "bp_25", tier: 3,  req: 500,  icon: "gem",            color: "text-red-300",     name: { pt: "1B Ouro",           en: "1B Gold"            }, type: "gold",  value: 1000000000 },
  { id: "bp_26", tier: 3,  req: 600,  icon: "flask-round",    color: "text-emerald-400", name: { pt: "1500 Poções",       en: "1500 Potions"       }, type: "pot",   value: 1500 },
  { id: "bp_27", tier: 3,  req: 700,  icon: "coins",          color: "text-red-300",     name: { pt: "5B Ouro",           en: "5B Gold"            }, type: "gold",  value: 5000000000 },
  { id: "bp_28", tier: 3,  req: 800,  icon: "flask-round",    color: "text-emerald-400", name: { pt: "2000 Poções",       en: "2000 Potions"       }, type: "pot",   value: 2000 },
  { id: "bp_29", tier: 3,  req: 900,  icon: "star",           color: "text-rose-300",    name: { pt: "25B Ouro",          en: "25B Gold"           }, type: "gold",  value: 25000000000 },
  { id: "bp_30", tier: 3,  req: 1000, icon: "flask-round",    color: "text-emerald-400", name: { pt: "3000 Poções",       en: "3000 Potions"       }, type: "pot",   value: 3000 },

  // ── TIER 4: Lenda (31–40) ──
  { id: "bp_31", tier: 4,  req: 1200, icon: "coins",          color: "text-purple-400",  name: { pt: "100B Ouro",         en: "100B Gold"          }, type: "gold",  value: 100000000000 },
  { id: "bp_32", tier: 4,  req: 1500, icon: "flask-round",    color: "text-emerald-400", name: { pt: "5000 Poções",       en: "5000 Potions"       }, type: "pot",   value: 5000 },
  { id: "bp_33", tier: 4,  req: 1750, icon: "crown",          color: "text-purple-400",  name: { pt: "500B Ouro",         en: "500B Gold"          }, type: "gold",  value: 500000000000 },
  { id: "bp_34", tier: 4,  req: 2000, icon: "flask-round",    color: "text-emerald-400", name: { pt: "7500 Poções",       en: "7500 Potions"       }, type: "pot",   value: 7500 },
  { id: "bp_35", tier: 4,  req: 2500, icon: "gem",            color: "text-purple-300",  name: { pt: "2T Ouro",           en: "2T Gold"            }, type: "gold",  value: 2000000000000 },
  { id: "bp_36", tier: 4,  req: 3000, icon: "flask-round",    color: "text-emerald-400", name: { pt: "10K Poções",        en: "10K Potions"        }, type: "pot",   value: 10000 },
  { id: "bp_37", tier: 4,  req: 3500, icon: "coins",          color: "text-purple-300",  name: { pt: "10T Ouro",          en: "10T Gold"           }, type: "gold",  value: 10000000000000 },
  { id: "bp_38", tier: 4,  req: 4000, icon: "flask-round",    color: "text-emerald-400", name: { pt: "15K Poções",        en: "15K Potions"        }, type: "pot",   value: 15000 },
  { id: "bp_39", tier: 4,  req: 4500, icon: "star",           color: "text-fuchsia-400", name: { pt: "50T Ouro",          en: "50T Gold"           }, type: "gold",  value: 50000000000000 },
  { id: "bp_40", tier: 4,  req: 5000, icon: "flask-round",    color: "text-emerald-400", name: { pt: "20K Poções",        en: "20K Potions"        }, type: "pot",   value: 20000 },

  // ── TIER 5: Mestre do Passe (41–49) ──
  { id: "bp_41", tier: 5,  req: 6000, icon: "coins",          color: "text-cyan-400",    name: { pt: "200T Ouro",         en: "200T Gold"          }, type: "gold",  value: 200000000000000 },
  { id: "bp_42", tier: 5,  req: 7000, icon: "flask-round",    color: "text-emerald-400", name: { pt: "30K Poções",        en: "30K Potions"        }, type: "pot",   value: 30000 },
  { id: "bp_43", tier: 5,  req: 8000, icon: "crown",          color: "text-cyan-400",    name: { pt: "1Qa Ouro",          en: "1Qa Gold"           }, type: "gold",  value: 1000000000000000 },
  { id: "bp_44", tier: 5,  req: 9000, icon: "flask-round",    color: "text-emerald-400", name: { pt: "50K Poções",        en: "50K Potions"        }, type: "pot",   value: 50000 },
  { id: "bp_45", tier: 5,  req: 10000,icon: "gem",            color: "text-cyan-300",    name: { pt: "5Qa Ouro",          en: "5Qa Gold"           }, type: "gold",  value: 5000000000000000 },
  { id: "bp_46", tier: 5,  req: 12000,icon: "coins",          color: "text-cyan-300",    name: { pt: "25Qa Ouro",         en: "25Qa Gold"          }, type: "gold",  value: 25000000000000000 },
  { id: "bp_47", tier: 5,  req: 15000,icon: "flask-round",    color: "text-emerald-400", name: { pt: "100K Poções",       en: "100K Potions"       }, type: "pot",   value: 100000 },
  { id: "bp_48", tier: 5,  req: 18000,icon: "star",           color: "text-white",       name: { pt: "100Qa Ouro",        en: "100Qa Gold"         }, type: "gold",  value: 100000000000000000 },
  { id: "bp_49", tier: 5,  req: 20000,icon: "flask-round",    color: "text-emerald-400", name: { pt: "500K Poções",       en: "500K Potions"       }, type: "pot",   value: 500000 },

  // ── NÍVEL 50: RECOMPENSA MÁXIMA — CLASSE EXCLUSIVA ──
  { id: "bp_50", tier: 6,  req: 25000,icon: "badge-check",    color: "text-yellow-300",
...
rpg.renderBattlePass = function () {
  ...
  const tierNames = {
    1: { pt: "Tier I — Iniciante",      en: "Tier I — Novice",     color: "text-zinc-400"    },
    2: { pt: "Tier II — Caçador",       en: "Tier II — Hunter",    color: "text-orange-400"  },
    3: { pt: "Tier III — Veterano",     en: "Tier III — Veteran",  color: "text-red-400"     },
    4: { pt: "Tier IV — Lenda",         en: "Tier IV — Legend",    color: "text-purple-400"  },
    5: { pt: "Tier V — Mestre",         en: "Tier V — Master",     color: "text-cyan-400"    },
    6: { pt: "⚔ Nível 50 — Recompensa Máxima", en: "⚔ Level 50 — Ultimate Reward", color: "text-yellow-300" },
  };
    ...
    list.innerHTML += `
      <div class="flex items-center gap-3 p-2.5 rounded-xl border ${borderCls} shadow-inner mb-1.5">
        ...
        <div class="flex-1 min-w-0">
          ...
          <p class="text-[9px] font-bold ${isClassReward ? "text-yellow-600" : "text-violet-400"} mt-0.5 tracking-wider uppercase">${formatNumber(r.req)} abates • Nível ${this.battlePassRewards.indexOf(r) + 1}</p>
        </div>
